package com.watchagents.wa.core
...
internal object ModuleConfig {
    ...
    const val WA_PACKAGE = "com.watchagents.wa"
    ...
    const val WA_VOICE_INTERACTION_COMPONENT =
        "$WA_PACKAGE/com.watchagents.wa.agent.voice.VoiceInteractionService"
