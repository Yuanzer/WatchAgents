...
import com.watchagents.wa.agent.model.AgentConversationCodec
import com.watchagents.wa.agent.model.AgentModelClient
import com.watchagents.wa.data.db.ConversationContextCheckpointEntity
import com.watchagents.wa.data.db.ConversationEntity
import com.watchagents.wa.data.db.ConversationMetadata
import com.watchagents.wa.data.db.ConversationMessageEntity
import com.watchagents.wa.data.db.ConversationStateEntity
...
internal object AgentConversationStore {
    ...
    private suspend fun loadSnapshot(context: Context): Snapshot {
        val dao = WaDatabase.get(context).conversationDao()
