package com.watchagents.wa.data.datastore
...
import com.watchagents.wa.data.model.AppearanceAccentColor
import com.watchagents.wa.data.model.AppearancePaletteStyle
import com.watchagents.wa.data.model.AppearanceSettings
import com.watchagents.wa.data.model.AppearanceThemeMode
import com.watchagents.wa.data.model.AppearanceTopBarBlurStyle
import com.watchagents.wa.data.model.Settings
...
internal object SettingsDataStore {
    private const val STORE_NAME = "wa_settings"
    ...
    private val APPEARANCE_SCREEN_SHAPE = stringPreferencesKey("appearance_screen_shape")
    private val APPEARANCE_ROTARY_DIRECTION = stringPreferencesKey("appearance_rotary_direction")
    private val APPEARANCE_VOLUME_KEY_ROTARY = booleanPreferencesKey("appearance_volume_key_rotary")
    ...
    private fun Preferences.toSettings(): Settings = Settings(
        ...
        appearance = AppearanceSettings(
            ...
            screenShape = WatchScreenShape.fromPersistedValue(this[APPEARANCE_SCREEN_SHAPE]),
            rotaryDirection = WatchRotaryDirection.fromPersistedValue(this[APPEARANCE_ROTARY_DIRECTION]),
            volumeKeyRotary = this[APPEARANCE_VOLUME_KEY_ROTARY] ?: false,
        ).normalized(),
    )
    ...
    private fun MutablePreferences.putAppearance(settings: AppearanceSettings) {
        ...
        this[APPEARANCE_SCREEN_SHAPE] = settings.screenShape.persistedValue
        this[APPEARANCE_ROTARY_DIRECTION] = settings.rotaryDirection.persistedValue
        this[APPEARANCE_VOLUME_KEY_ROTARY] = settings.volumeKeyRotary
    }
}
