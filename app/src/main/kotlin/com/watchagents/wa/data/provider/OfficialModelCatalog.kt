...
internal object OfficialModelCatalog {
    ...
    /** 按来源类型与模型名查目录中的上下文窗口；未收录时返回 null。 */
    fun contextWindowFor(sourceType: String?, modelId: String): Int? {
        val catalogId = sourceType?.takeIf { it != ProviderSourceTypes.CUSTOM } ?: return null
        return modelsByCatalogId[catalogId]
