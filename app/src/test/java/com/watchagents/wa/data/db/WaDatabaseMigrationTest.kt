package com.watchagents.wa.data.db
...
import com.watchagents.wa.data.model.ModelSource
...
class WaDatabaseMigrationTest {
    ...
    fun migration6To15PreservesDataAndMovesBoundedConversationContext() {
        ...
        val database = Room.databaseBuilder(context, WaDatabase::class.java, databaseName)
            .addMigrations(
                WaDatabase.MIGRATION_6_7,
                WaDatabase.MIGRATION_7_8,
                WaDatabase.MIGRATION_8_9,
                WaDatabase.MIGRATION_9_10,
                WaDatabase.MIGRATION_10_11,
                WaDatabase.MIGRATION_11_12,
                WaDatabase.MIGRATION_12_13,
                WaDatabase.MIGRATION_13_14,
                WaDatabase.MIGRATION_14_15,
            )
            .build()
        try {
